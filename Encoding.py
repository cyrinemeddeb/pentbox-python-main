...
class Encoding:
	...
	def encode(cls,data, method):
		if(method in ['utf8','ascii']):
			...
			print('Votre message codé est : ' + encoded_text)
			return(encoded_text)
			...
			print('Votre message codé est : ' + base64_message)
			...
			print('Votre message codé est : ' + base32_message)
			...
			print('Votre message codé est : ' + base16_message)
	...
	def decode(cls, encoded_data, method):
		if(method in ['utf8','ascii']):
			...
			print('Votre message décodé est : ' + data)
			return(data)
			...
			base64_message = base64_bytes.decode('ascii')
			print('Votre message décodé est : ' + base64_message)
			return(base64_message)
			...
			base32_message = base32_bytes.decode('ascii')
			print('Votre message décodé est : ' + base32_message)
			return(base32_message)
			...
			base16_message = base16_bytes.decode('ascii')
			print('Votre message décodé est : ' + base16_message)
			return(base16_message)
